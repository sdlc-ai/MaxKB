export default {
  ...
  theme: {
    ...
    defaultTip: 'The default is the SDLC-KB platform interface, supports custom settings',
    logoDefaultTip: 'The default is the SDLC-KB login interface, supports custom settings',
